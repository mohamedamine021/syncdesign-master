    ...
    <StepLayout stepNumber={9} title="Système d'excitation" description="Calcul du courant d'excitation et vérifications thermiques">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="rounded-lg border border-border p-5 space-y-1">
          <h3 className="text-sm font-semibold text-foreground mb-4">Calculs du système d'excitation</h3>
          ...
          <div className={`mt-4 p-3 rounded-md border text-sm ${excitation.ThetaB <= 100 ? 'border-success/50 bg-success/10 text-success' : 'border-destructive/50 bg-destructive/10 text-destructive'}`}>
        ...
        <div className="rounded-lg border border-border p-5 bg-muted/30">
          <h3 className="text-sm font-semibold text-foreground mb-4">Résumé - Système d'excitation</h3>
